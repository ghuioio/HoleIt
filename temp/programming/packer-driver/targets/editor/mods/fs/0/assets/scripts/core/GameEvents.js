System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, EventTarget, _crd, gameEvents, GameEvent;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "cb0a0aeAnNIf6Km//em+dmG", "GameEvents", undefined);
       ...
       */
      _export("gameEvents", gameEvents = new EventTarget());
