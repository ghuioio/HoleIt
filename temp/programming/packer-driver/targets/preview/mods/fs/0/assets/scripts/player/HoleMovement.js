    ...
    execute: function () {
      ...
      _export("HoleMovement", HoleMovement = (_dec = ccclass('HoleMovement'), _dec2 = property({
        ...
        update(deltaTime) {
          ...
          var targetVX = this._input.x * this.moveSpeed;
          var zSign = this.invertZ ? -1 : 1;
          var targetVZ = this._input.y * this.moveSpeed * zSign;
          var hasInput = this._input.lengthSqr() > 0.000001;
          var maxDelta = (hasInput ? this.acceleration : this.deceleration) * dt;
