    ...
    execute: function () {
      ...
      _export("HoleEater", HoleEater = (_dec = ccclass('HoleEater'), _dec2 = property({
        ...
        update(deltaTime) {
          ...
          var radiusSq = this.eatRadius * this.eatRadius;
          var started = 0;
          ...
          for (var i = 0; i < this._candidates.length; i++) {
            ...
            var dx = this._itemWorldPos.x - this._holeWorldPos.x;
            var dz = this._itemWorldPos.z - this._holeWorldPos.z;
            ...
            var delay = Math.max(0, this._itemWorldPos.y) * this.heightDelayFactor + started % 4 * 0.008;
