System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, _decorator, Component, Label, Sprite, GameEvent, gameEvents, _dec, _dec2, _dec3, _class, _class2, _descriptor, _descriptor2, _temp, _crd, ccclass, property, HoleLevelUI;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "0fa21p5n4tNFqj8di6iVvM/", "HoleLevelUI", undefined);
      ...
      _export("HoleLevelUI", HoleLevelUI = (_dec = ccclass('HoleLevelUI'), _dec2 = property({
        type: Label
      }), _dec3 = property({
        type: Sprite,
        tooltip: 'Set Sprite Type=FILLED in Inspector.'
      }), _dec(_class = (_class2 = (_temp = class HoleLevelUI extends Component {
        constructor() {
          super(...arguments);
        ...
        onEnable() {
          (_crd && gameEvents === void 0 ? (_reportPossibleCrUseOfgameEvents({
            ...
            error: Error()
          }), GameEvent) : GameEvent).HOLE_PROGRESS_CHANGED, this.onProgress, this);
        }
      ...
      }, _temp), (_descriptor = _applyDecoratedDescriptor(_class2.prototype, "levelLabel", [_dec2], {
        configurable: true,
        enumerable: true,
        writable: true,
...
//# sourceMappingURL=HoleLevelUI.js.map